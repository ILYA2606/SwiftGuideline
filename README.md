...
* [Начнем с перфекционизма](#correctness)
* [Ширина страницы](#page-guide)
* [Именование](#naming)
  * [Методы](#prose)
  * [Булевы](#booleans)
  * [Делегаты](#delegates)
  * [Зависимый от типа контекст](#use-type-inferred-context)
  * [Обобщения (Generics)](#generics)
  * [Префиксы класса](#class-prefixes)
  * [Язык](#language)
* [Организация кода](#code-organization)
  * [Соответствие протокола](#protocol-conformance)
  * [Неиспользованный код](#unused-code)
  * [Минимальный импорт](#minimal-imports)
* [Отступы](#spacing)
* [Комментарии](#comments)
* [Классы и структуры](#classes-and-structures)
  * [Использование self](#use-of-self)
  * [Вычисляемые свойства](#computed-properties)
  * [Использование final](#final)
* [Объявление функций](#function-declarations)
* [Выражения замыканий](#closure-expressions)
* [Типы](#types)
  * [Константы](#constants)
  * [Статические методы и свойства типа переменных](#static-methods-and-variable-type-properties)
  * [Необязательные значения (Optionals)](#optionals)
  * [Ленивая инициализация](#lazy-initialization)
  * [Вывод типа](#type-inference)
  * [Синтаксический сахар](#syntactic-sugar)
  * [Массивы и словари](#arrays-and-dictionaries)
* [Функции против Методов](#functions-vs-methods)
* [Управление памятью](#memory-management)
  * [Продление срока жизни объекта](#extending-lifetime)
* [Контроль доступа](#access-control)
* [Поток управления](#control-flow)
* [Золотой путь](#golden-path)
* [Использование guard](#guards)
  * [Обработка guard](#failing-guards)
* [Точки с запятой](#semicolons)
* [Круглые скобки](#parentheses)
* [Формат организации и Bundle Identifier](#organization-and-bundle-identifier)
* [Ссылки](#references)
...
- Начинайте фабричные методы через “make” (Например, _makeProduct_)
- Методы именования:
  - методы в форме глагола следуют правилу -ed, -ing для неизменяемого объекта (Например, _sorted_)
  - методы в форме глагола следуют правилу первой формы для изменяемого объекта (Например, _sort_)
  - булевы типы должны читаться, как утверждения (Например, _isEnabled_)
  - протоколы должны описывать существительные (Например, Sphere -> _Spherable_)
  - протоколы, описывающие возможность, должны заканчиваться в -able или -ible (Например, _Fuckable_)
...
- Используйте аббревиатуры только в верхнем или нижнем регистре (Например, _userID_, _isRepresentableAsASCII_, _utf8Bytes_)
- Давайте одинаковое базовое имя для методов, которые имеют одинаковое значение (Например, не использовать где-то _configurate_, а где-то _setup_)
...
Пишите имя метода без параметров (Например, _addTarget_)
Пишите имя метода с метками аргументов (Например, _addTarget(:action:)_)
Пишите полное имя метода с метками и типами аргументов (Например, _addTarget(_: Any?, action: Selector?)_)
